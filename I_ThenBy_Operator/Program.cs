...
namespace I_ThenBy_Operator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Method Syntax
            var studentMethodSingle = student.OrderBy(std => std.FirstName).ThenBy(std => std.Age).ToList();
            ...
            Console.WriteLine("------------------------------------");
            var studentMethodMultiple = student.OrderBy(std => std.FirstName).ThenBy(std => std.LastName).ThenBy(std=> std.Age).ToList();
            ...
            var studentQuerySingle=(from std in student
                                   orderby std.FirstName, std.LastName ascending
                                   select std).ToList();
            ...
            var studentQueryMultiple = (from std in student
                                      orderby std.FirstName, std.LastName ascending, std.Age ascending
                                      select std).ToList();
